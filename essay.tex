...
In fact the representations obtained by these authors are $p$-adic Galois representations $\rho_f\colon \GQ \to \GL_2(\QQ_p)$ and the representations in the theorem are then obtained from the $p$-adic one by a process of reduction and semisimplification. %TODO
...
We fix a prime $p$ and a normalised eigenform $f \in S_k(N, \varepsilon, \Fb_p)$ to look at, let $f$ have $q$-expansion %TODO Fb FF?
\[

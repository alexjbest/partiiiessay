...
%TODO why problem in 2 case here but not earlier?
...
Then let $H$ be the group of squares in $(\ZZ/13\ZZ)^*$, i.e. the kernel of $\phi$.
Doing this we see that in fact $f$ may be viewed as a cusp form of weight 2 for the group
\[
...
The order of a character for such a form must divide 2.

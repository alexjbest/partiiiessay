...
There is also a chapter by Ribet--Stein \cite{RibetStein}. %TODO separate more expositary, move researchy ones to relevant sections.
...
There are many good references for this type of material, for example \cite{WieseGal}. %TODO something classical?
...
The groups we have been looking at correspond to important extensions on the Galois side. %TODO
Let $\Qp^{\nr}$ denote the maximal non-ramified extension of $\Qp$ and $\Qp^{\tamr}$ denote the maximal tamely-ramified extension of $\Qp$. %TODO what does this mean?
\[
\xymatrix{
...
Galois representations are determined completely by the images of Frobenius elements. %TODO
\end{thm}
...
So this product will always be the unique fundamental character of level 1. %TODO is this cycl?
\end{rmk}
...
However the space of weight 2 cusp forms on $\Gamma_H(13)$ is zero, and so $f$ does not exist. %TODO
\end{ex}
